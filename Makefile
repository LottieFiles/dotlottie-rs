...
APPLE_WATCHOS := watchos
APPLE_WATCHOS_PLATFORM := WatchOS
APPLE_WATCHOS_SDK ?= WatchOS
APPLE_WATCHOS_VERSION_MIN ?= 5.0

APPLE_WATCHOS_SIMULATOR := watchos-simulator
APPLE_WATCHOS_SIMULATOR_PLATFORM := WatchSimulator
APPLE_WATCHOS_SIMULATOR_SDK ?= WatchSimulator
...
APPLE_WATCHOS_FRAMEWORK_TYPE := $(APPLE_WATCHOS)
APPLE_WATCHOS_SIMULATOR_FRAMEWORK_TYPE := $(APPLE_WATCHOS_SIMULATOR)
APPLE_TVOS_FRAMEWORK_TYPE := $(APPLE_TVOS)
APPLE_TVOS_SIMULATOR_FRAMEWORK_TYPE := $(APPLE_TVOS_SIMULATOR)
APPLE_FRAMEWORK_TYPES := $(APPLE_IOS_FRAMEWORK_TYPE) $(APPLE_IOS_SIMULATOR_FRAMEWORK_TYPE) $(APPLE_MACOSX_FRAMEWORK_TYPE) $(APPLE_VISIONOS_FRAMEWORK_TYPE) $(APPLE_VISIONOS_SIMULATOR_FRAMEWORK_TYPE) $(APPLE_WATCHOS_FRAMEWORK_TYPE) $(APPLE_WATCHOS_SIMULATOR_FRAMEWORK_TYPE) $(APPLE_TVOS_FRAMEWORK_TYPE) $(APPLE_TVOS_SIMULATOR_FRAMEWORK_TYPE)
...
$(if $(filter $(PLATFORM),$(APPLE_WATCHOS_PLATFORM) $(APPLE_WATCHOS_SIMULATOR_PLATFORM)),\
[built-in options]\n\
cpp_args = ['-mwatchos-version-min=$(APPLE_WATCHOS_VERSION_MIN)']\n\
cpp_link_args = ['-mwatchos-version-min=$(APPLE_WATCHOS_VERSION_MIN)']\n\
,)
...
define CARGO_BUILD
	if [ "$(CARGO_TARGET)" = "wasm32-unknown-emscripten" ]; then \
		...
		--features thorvg-v1,uniffi \
		--release; \
	elif [ "$(CARGO_TARGET)" = "aarch64-apple-watchos" ] || [ "$(CARGO_TARGET)" = "aarch64-apple-watchos-sim" ] || [ "$(CARGO_TARGET)" = "x86_64-apple-watchos-sim" ] || [ "$(CARGO_TARGET)" = "arm64_32-apple-watchos" ] || [ "$(CARGO_TARGET)" = "armv7k-apple-watchos" ]; then \
		WATCHOS_DEPLOYMENT_TARGET=$(APPLE_WATCHOS_VERSION_MIN) \
		cargo +nightly build \
		-Z build-std=std,panic_abort \
		--manifest-path $(PROJECT_DIR)/Cargo.toml \
		--target $(CARGO_TARGET) \
...
define CREATE_FRAMEWORK
	...
	$(PLISTBUDDY_EXEC) -c "Add :CFBundleIdentifier string com.dotlottie.$(DOTLOTTIE_PLAYER_MODULE)" \
                     ...
                     -c "Add :MinimumOSVersion string $(if $(findstring macosx,$(BASE_DIR)),$(APPLE_MACOS_VERSION_MIN),$(if $(findstring visionos,$(BASE_DIR)),$(APPLE_VISIONOS_VERSION_MIN),$(if $(findstring watchos,$(BASE_DIR)),$(APPLE_WATCHOS_VERSION_MIN),$(if $(findstring tvos,$(BASE_DIR)),$(APPLE_TVOS_VERSION_MIN),$(APPLE_IOS_VERSION_MIN)))))" \
...
$(if $(filter $3,$(APPLE_WATCHOS_PLATFORM)),\
$1_FRAMEWORK_TYPE := $(APPLE_WATCHOS_FRAMEWORK_TYPE)
APPLE_WATCHOS_FRAMEWORK_TARGETS += $$($1))

$(if $(filter $3,$(APPLE_WATCHOS_SIMULATOR_PLATFORM)),\
$1_FRAMEWORK_TYPE := $(APPLE_WATCHOS_SIMULATOR_FRAMEWORK_TYPE)
APPLE_WATCHOS_SIMULATOR_FRAMEWORK_TARGETS += $$($1))
...
$(eval $(call DEFINE_APPLE_TARGET,aarch64-apple-watchos,WATCHOS64,arm64,arm,aarch64,$(APPLE_WATCHOS),$(APPLE_WATCHOS_PLATFORM),$(APPLE_WATCHOS_SDK)))
$(eval $(call DEFINE_APPLE_TARGET,aarch64-apple-watchos-sim,WATCHOS_SIMULATOR64,arm64,arm,aarch64,$(APPLE_WATCHOS),$(APPLE_WATCHOS_SIMULATOR_PLATFORM),$(APPLE_WATCHOS_SIMULATOR_SDK)))
$(eval $(call DEFINE_APPLE_TARGET,x86_64-apple-watchos-sim,WATCHOS_SIMULATOR_X64,x86_64,x86_64,x86_64,$(APPLE_WATCHOS),$(APPLE_WATCHOS_SIMULATOR_PLATFORM),$(APPLE_WATCHOS_SIMULATOR_SDK)))
$(eval $(call DEFINE_APPLE_TARGET,arm64_32-apple-watchos,WATCHOS64_32,arm64_32,arm,arm64_32,$(APPLE_WATCHOS),$(APPLE_WATCHOS_PLATFORM),$(APPLE_WATCHOS_SDK)))
$(eval $(call DEFINE_APPLE_TARGET,armv7k-apple-watchos,WATCHOS,armv7k,arm,armv7k,$(APPLE_WATCHOS),$(APPLE_WATCHOS_PLATFORM),$(APPLE_WATCHOS_SDK)))
...
$(eval $(call DEFINE_APPLE_TARGET,x86_64-apple-tvos-sim,TVOS_SIMULATOR_X64,x86_64,x86_64,x86_64,$(APPLE_TVOS),$(APPLE_TVOS_SIMULATOR_PLATFORM),$(APPLE_TVOS_SIMULATOR_SDK)))
...
$(eval $(call NEW_APPLE_DEPS_BUILD,AARCH64_APPLE_WATCHOS))
$(eval $(call NEW_APPLE_DEPS_BUILD,AARCH64_APPLE_WATCHOS_SIM))
$(eval $(call NEW_APPLE_DEPS_BUILD,X86_64_APPLE_WATCHOS_SIM))
$(eval $(call NEW_APPLE_DEPS_BUILD,ARM64_32_APPLE_WATCHOS))
$(eval $(call NEW_APPLE_DEPS_BUILD,ARMV7K_APPLE_WATCHOS))
$(eval $(call NEW_APPLE_DEPS_BUILD,AARCH64_APPLE_TVOS))
$(eval $(call NEW_APPLE_DEPS_BUILD,AARCH64_APPLE_TVOS_SIM))
$(eval $(call NEW_APPLE_DEPS_BUILD,X86_64_APPLE_TVOS_SIM))
...
$(eval $(call NEW_APPLE_BUILD,AARCH64_APPLE_WATCHOS))
$(eval $(call NEW_APPLE_BUILD,AARCH64_APPLE_WATCHOS_SIM))
$(eval $(call NEW_APPLE_BUILD,X86_64_APPLE_WATCHOS_SIM))
$(eval $(call NEW_APPLE_BUILD,ARM64_32_APPLE_WATCHOS))
$(eval $(call NEW_APPLE_BUILD,ARMV7K_APPLE_WATCHOS))
$(eval $(call NEW_APPLE_BUILD,AARCH64_APPLE_TVOS))
$(eval $(call NEW_APPLE_BUILD,AARCH64_APPLE_TVOS_SIM))
$(eval $(call NEW_APPLE_BUILD,X86_64_APPLE_TVOS_SIM))
...
$(eval $(call NEW_APPLE_FRAMEWORK,$(APPLE_WATCHOS_FRAMEWORK_TYPE),$(APPLE_WATCHOS_FRAMEWORK_TARGETS),$(APPLE_WATCHOS_PLATFORM),))
$(eval $(call NEW_APPLE_FRAMEWORK,$(APPLE_WATCHOS_SIMULATOR_FRAMEWORK_TYPE),$(APPLE_WATCHOS_SIMULATOR_FRAMEWORK_TARGETS),$(APPLE_WATCHOS_SIMULATOR_PLATFORM),))
