...
$4/$(CMAKE_CACHE): OSX_SYSROOT := -DCMAKE_OSX_SYSROOT=Developer/SDKs/$$($1_SDK).sdk
$4/$(CMAKE_CACHE): DEPLOYMENT_TARGET := -DCMAKE_DEPLOYMENT_TARGET=11.0
endif

ifeq ($$($1_SUBSYSTEM), ios)
$4/$(CMAKE_CACHE): OSX_SYSROOT := -DCMAKE_OSX_SYSROOT=Developer/SDKs/$$($1_SDK).sdk
$4/$(CMAKE_CACHE): DEPLOYMENT_TARGET := -DCMAKE_DEPLOYMENT_TARGET=12.0
endif
