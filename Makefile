...
define SETUP_CMAKE
	@echo "Running cmake with: -DCMAKE_INSTALL_PREFIX=$(DEP_ARTIFACTS_DIR) $(CMAKE_BUILD_SETTINGS) $(PLATFORM) $(TOOLCHAIN_FILE) $(C_FLAGS) $(OSX_SYSROOT) $(OSX_DEPLOYMENT_TARGET)"

	cmake -DCMAKE_INSTALL_PREFIX=$(DEP_ARTIFACTS_DIR) \
		-DCMAKE_POSITION_INDEPENDENT_CODE=ON \
		-DBUILD_SHARED_LIBS=OFF $(CMAKE_BUILD_SETTINGS) $(PLATFORM) $(TOOLCHAIN_FILE) $(C_FLAGS) $(OSX_SYSROOT) $(OSX_DEPLOYMENT_TARGET) \
		-B $(DEP_BUILD_DIR) \
		$(DEP_SOURCE_DIR)
endef
...
$4/$(CMAKE_CACHE): OSX_SYSROOT := -DCMAKE_OSX_SYSROOT=/Applications/$(APPLE_XCODE_APP_NAME)/Contents/Developer/Platforms/$$($1_PLATFORM).platform/Developer/SDKs/$$($1_SDK).sdk
$4/$(CMAKE_CACHE): OSX_DEPLOYMENT_TARGET := -DCMAKE_OSX_DEPLOYMENT_TARGET=11.0
endif

ifeq ($$($1_SUBSYSTEM), ios)
$4/$(CMAKE_CACHE): OSX_SYSROOT := -DCMAKE_OSX_SYSROOT=/Applications/$(APPLE_XCODE_APP_NAME)/Contents/Developer/Platforms/$$($1_PLATFORM).platform/Developer/SDKs/$$($1_SDK).sdk
$4/$(CMAKE_CACHE): OSX_DEPLOYMENT_TARGET := -DCMAKE_OSX_DEPLOYMENT_TARGET=12.0
endif
...
$(eval $(call NEW_THORVG_BUILD,$1,false,false,""""))
endef
...
$(THORVG_LOCAL_ARCH_BUILD_DIR)/$(NINJA_BUILD_FILE): EXTRA := ""
