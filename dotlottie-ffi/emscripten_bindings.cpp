...
EMSCRIPTEN_BINDINGS(DotLottiePlayer)
{
    ...
    class_<DotLottiePlayer>("DotLottiePlayer")
        ...
        .function("setSlots", &DotLottiePlayer::set_slots_str)
        .function("getSlotIds", &DotLottiePlayer::get_slot_ids)
        .function("getSlotType", &DotLottiePlayer::get_slot_type)
        .function("getSlotStr", &DotLottiePlayer::get_slot_str)
        .function("getSlotsStr", &DotLottiePlayer::get_slots_str)
        .function("setSlotStr", &DotLottiePlayer::set_slot_str)
        .function("resetSlot", &DotLottiePlayer::reset_slot)
        .function("resetSlots", &DotLottiePlayer::reset_slots)
        .function("clearSlots", &DotLottiePlayer::clear_slots)
        .function("clearSlot", &DotLottiePlayer::clear_slot)
        .function("setQuality", &DotLottiePlayer::set_quality)
        ...
        .function("stateMachineGetInputs", &DotLottiePlayer::state_machine_get_inputs)
