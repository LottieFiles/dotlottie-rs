...
EMSCRIPTEN_BINDINGS(DotLottiePlayer)
{
    ...
    class_<DotLottiePlayer>("DotLottiePlayer")
        ...
        .function("stateMachineSetPropagateEvents", &DotLottiePlayer::state_machine_set_propagate_events)
        .function("stateMachineSetPlaybackActionsActive", &DotLottiePlayer::state_machine_set_playback_actions_active)
