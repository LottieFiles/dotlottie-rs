...
pub struct LottieRenderer {
    ...
    picture_width: f32,
    picture_height: f32,
    pub color_space: Option<thorvg::TvgColorspace>,
    pub width: u32,
    pub height: u32,
    pub buffer: Vec<u32>,
...
impl LottieRenderer {
    pub fn new() -> Self {
        Self {
            ...
            buffer: vec![],
            color_space: Some(thorvg::TvgColorspace::ABGR8888),
            width: 0,
            height: 0,
            picture_width: 0.0,
            picture_height: 0.0,
    ...
    pub fn load_path(
        ...
        thorvg_canvas
            .set_target(&mut self.buffer, width, width, height, color_space.clone())
    ...
    pub fn resize(&mut self, width: u32, height: u32) -> Result<(), LottieRendererError> {
        ...
        thorvg_canvas
            .set_target(&mut buffer, width, width, height, color_space.clone())
            .map_err(LottieRendererError::ThorvgError)?;
    ...
    pub fn set_target(
        ...
        thorvg_canvas
            .set_target(&mut self.buffer, width, width, height, color_space)
            .map_err(LottieRendererError::ThorvgError)?;
