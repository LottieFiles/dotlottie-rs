...
cargo +nightly run --target aarch64-apple-ios-sim --features=uniffi/cli --bin uniffi-bindgen generate src/dlplayer.udl  --language swift --out-dir uniffi-bindings
